...
public class PortalControlador {
    ...
    public String perfil(ModelMap modelo, HttpSession session){
        UsuarioRol usuario = (UsuarioRol) session.getAttribute("usuariosession");
        modelo.put("usuario", usuario);
        return "usuarioRol_modificar.html";
    }
    ...
    public String actualizar(@RequestParam MultipartFile archivo, @PathVariable String id, @RequestParam String nombre, @RequestParam String email,
        ...
        try {
            usuarioRolServicio.actualizar(archivo, id, nombre, email, password, password2);
